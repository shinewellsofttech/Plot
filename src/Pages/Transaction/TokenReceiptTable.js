...
const TokenReceiptTable = ({ plotData, plotOptions, onRemove, onAdd, onDataChange, isEditMode, isReadOnly, plotDropdownRefs, actualPriceRefs, addButtonRefs }) => {
...
export default TokenReceiptTable;
